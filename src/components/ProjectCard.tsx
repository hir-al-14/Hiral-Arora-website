...
function ProjectDescription({
  ...
  const parts = description.split(
    /(HackDavis 2025|HackDavis 2026|Best Technical Project)/g
  );
...
export default function ProjectCard({
  ...
  const label = project.github
    ? `Open ${project.title} on GitHub`
    : `GitHub link for ${project.title} coming soon`;
      ...
      <div className="project-card-body">
        <div className="project-card-heading">
          ...
          {project.github ? (
            ...
            <span
              className="project-github project-github--placeholder"
              role="img"
              aria-label={label}
              title={label}
            >
