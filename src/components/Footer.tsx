    ...
    <footer className="footer" id="contact">
      <div className="footer-inner">
        <div className="footer-note">
          ...
          <a className="footer-email" href="mailto:hirarora@ucdavis.edu">hirarora@ucdavis.edu<span aria-hidden="true">↗</span></a>
        </div>
        <nav className="footer-links" aria-label="Contact links">
          ...
          <a href="https://drive.google.com/file/d/1qO3eGcy2hstKphAPrG_h6VQUhAnbup-p/view?usp=sharing" target="_blank" rel="noreferrer">Resume ↗</a>
        </nav>
        <div className="footer-bottom"><span>© {new Date().getFullYear()} Hiral Arora · Davis, CA</span><a href="#top">back to top ↑</a></div>
      </div>
    </footer>
  );
}
